...
const Signup = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-white px-4">
      ...
      <div className="bg-white text-black rounded-lg p-8 shadow-lg w-full max-w-100 min-w-50">
      <h2 className="text-3xl text-center text-slate-800 font-bold mb-8">wiseagent.ai</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-2 px-4 bg-[#ff7159] text-white rounded-md hover:bg-orange-600 font-semibold transition-colors"
          >
            Sign Up
          </button>
        </form>
        ...
        <div className="mt-6 text-center">
          <p className="text-slate-600">
            ...
            <a href="/login" className="text-slate-700 hover:text-slate-900 font-medium">
              Log In
            </a>
          </p>
        </div>
